...
process_TRA_data(TRA_data2,CDRlocus ) %>% 
  ...
  theme_classic()+
  ggtitle(paste0("CD8 TRA  ",CDRlocus))+
  theme_linedraw() +
  xlab('Length(nt)') +
  ylab('ratio(%)') +
...
ggsave(plot=Pall,"/home/maolp/Main_Gao_ScanpyProject20231130/HFB_Figure_Plot/Sup_Figure4/S24/CD8_TRA.pdf", width = 6, height = 10, dpi = 300)
```
...
# ggsave(plot=Psig,"/home/maolp/Main_Gao_ScanpyProject20231130/HFB_Figure_Plot/Sup_Figure4/S24sig/CD8TRAsig.pdf", width = 6, height = 10, dpi = 600)
```
...
Immusig_plot(TRA_data2, c("N-REGION", "3'V-REGION", "5'J-REGION"), "TRA",
                         "/home/maolp/Main_Gao_ScanpyProject20231130/HFB_Figure_Plot/Sup_Figure4/S24sig/CD4TRAsig.pdf")
```
