...
ggsave(paste0("/home/maolp/Main_Gao_ScanpyProject20231130/HFB_Figure_Plot/Sup_Figure4/S22/",Celltype,"_",CDRlocus,".pdf"),width = 6,height =4)
```
```{r}
CDRlocus="3'V-REGION"
process_TRB_data(TRB_data2,CDRlocus ) %>% 
...
ggsave(plot=Pall,"/home/maolp/Main_Gao_ScanpyProject20231130/HFB_Figure_Plot/Sup_Figure4/S22//AllTRB.pdf", width = 6, height = 20, dpi = 300)
```
```{r}
P5J
```
...
Jpval_plot <- create_pval_plot(
    Jpvalue,titlex="Percentage of TRB Jregion Lengths Over Time")+xlab("Lengths(nt)")
print(Jpval_plot)
```
...
ggsave(plot=Psig,"/home/maolp/Main_Gao_ScanpyProject20231130/HFB_Figure_Plot/Sup_Figure4/S24sig/AllTRBsig.pdf", width = 6, height = 16, dpi = 600)
```
```{r}
Immusig_plot(TRB_data2, c("N1-REGION", "N2-REGION", "3'V-REGION", "5'J-REGION", "D-REGION"), "TRB",
                         "/home/maolp/Main_Gao_ScanpyProject20231130/HFB_Figure_Plot/Sup_Figure4/S24sig/AllTRBsig.pdf")
```
